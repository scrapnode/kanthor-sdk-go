...
func NewEndpointDeleteRes() *EndpointDeleteRes {
...
func (o *EndpointDeleteRes) HasAppId() bool {
	if o != nil && !IsNil(o.AppId) {
		return true
	}
...
func (o *EndpointDeleteRes) GetCreatedAt() int32 {
...
// and a boolean to check if the value has been set.
func (o *EndpointDeleteRes) GetCreatedAtOk() (*int32, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *EndpointDeleteRes) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *EndpointDeleteRes) SetCreatedAt(v int32) {
	o.CreatedAt = &v
}
...
func (o *EndpointDeleteRes) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *EndpointDeleteRes) HasMethod() bool {
	if o != nil && !IsNil(o.Method) {
		return true
	}
...
func (o *EndpointDeleteRes) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *EndpointDeleteRes) GetUpdatedAt() int32 {
...
// and a boolean to check if the value has been set.
func (o *EndpointDeleteRes) GetUpdatedAtOk() (*int32, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *EndpointDeleteRes) HasUpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *EndpointDeleteRes) SetUpdatedAt(v int32) {
	o.UpdatedAt = &v
}
...
func (o *EndpointDeleteRes) HasUri() bool {
	if o != nil && !IsNil(o.Uri) {
		return true
	}
