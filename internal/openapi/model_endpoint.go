...
func (o *Endpoint) GetCreatedAt() int32 {
...
// and a boolean to check if the value has been set.
func (o *Endpoint) GetCreatedAtOk() (*int32, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *Endpoint) SetCreatedAt(v int32) {
	o.CreatedAt = &v
}
...
func (o *Endpoint) GetUpdatedAt() int32 {
...
// and a boolean to check if the value has been set.
func (o *Endpoint) GetUpdatedAtOk() (*int32, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *Endpoint) SetUpdatedAt(v int32) {
	o.UpdatedAt = &v
}
