...
func NewEndpointGetRes() *EndpointGetRes {
	this := EndpointGetRes{}
	return &this
}
...
func (o *EndpointGetRes) HasAppId() bool {
	if o != nil && !IsNil(o.AppId) {
		return true
	}
...
func (o *EndpointGetRes) GetCreatedAt() int32 {
...
// and a boolean to check if the value has been set.
func (o *EndpointGetRes) GetCreatedAtOk() (*int32, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *EndpointGetRes) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *EndpointGetRes) SetCreatedAt(v int32) {
	o.CreatedAt = &v
}
...
func (o *EndpointGetRes) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *EndpointGetRes) HasMethod() bool {
	if o != nil && !IsNil(o.Method) {
		return true
	}
...
func (o *EndpointGetRes) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *EndpointGetRes) GetUpdatedAt() int32 {
...
// and a boolean to check if the value has been set.
func (o *EndpointGetRes) GetUpdatedAtOk() (*int32, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *EndpointGetRes) HasUpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *EndpointGetRes) SetUpdatedAt(v int32) {
	o.UpdatedAt = &v
}
...
func (o *EndpointGetRes) HasUri() bool {
	if o != nil && !IsNil(o.Uri) {
		return true
	}
